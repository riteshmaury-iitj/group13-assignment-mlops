...
Ritesh Maury \newline G25AIT2087 &
  ...
  \href{https://www.kaggle.com/code/ritesh329/train-model}{\small ritesh329} &
  \href{https://huggingface.co/Recurrent/ag-news-distilbert}{\small Recurrent} &
  \href{https://wandb.ai/models-iit-jodhpur/mlops-assignment-group13}{\small models-iit-jodhpur} \\
Kosuru Yuvaraj \newline G25AIT2054 &
...
Laishram K. Chanu \newline G25AIT2056 &
  \href{https://github.com/riteshmaury-iitj/group13-assignment-mlops}{\small group13-mlops} &
  \href{https://www.kaggle.com/code/khumanleima/notebook35f6cea6a6}{\small khumanleima} &
  \href{https://huggingface.co/LKHUMANLEIMA/ag-news-distilbert}{\small LKHUMANLEIMA} &
  \href{https://wandb.ai/g25ait2056-indian-institute-of-technology-jodhpur/mlops-assignment3?nw=nwuserg25ait2056}{\small g25ait2056} \\
Guntakal Sandeep \newline G25AIT2036 &
  \href{https://github.com/riteshmaury-iitj/group13-assignment-mlops/tree/Sandeep\_dev}{\small Sandeep\_dev} &
  \href{https://www.kaggle.com/code/guntakalsandeepkumar/g25ait2036}{\small guntakalsandeep} &
  \href{https://huggingface.co/guntaksa/AG-News-distilbert1}{\small guntaksa} &
  \href{https://wandb.ai/g25ait2036-indian-institue-of-technology-jodhpur/mlops-assignment3}{\small g25ait2036} \\
\bottomrule
\end{tabular}

\vspace{0.5cm}

{\bfseries\color{darkgreen} Individual Member Links}

\vspace{0.2cm}
\renewcommand{\arraystretch}{1.5}
\begin{tabular}{p{1.8cm}p{3.8cm}p{9cm}}
\toprule
\textbf{Roll No} & \textbf{Resource} & \textbf{Link} \\
\midrule
G25AIT2087 & GitHub & \url{https://github.com/riteshmaury-iitj} \\
           & Prepared Data (HF) & \url{https://huggingface.co/datasets/Recurrent/prepared_data_mlops2} \\
           & Data Preparation & \url{https://github.com/riteshmaury-iitj/group13-assignment-mlops/blob/main/notebooks/prepare_data.ipynb} \\
           & Model Training (Kaggle) & \url{https://www.kaggle.com/code/ritesh329/train-model} \\
           & Model Inference (Kaggle) & \url{https://www.kaggle.com/code/ritesh329/model-inferenence} \\
           & HuggingFace Model & \url{https://huggingface.co/Recurrent/ag-news-distilbert} \\
           & W\&B & \url{https://wandb.ai/models-iit-jodhpur/mlops-assignment-group13} \\
\midrule
G25AIT2054 & GitHub & \url{https://github.com/yuvarajkosuru} \\
           & Kaggle Notebook & \url{https://www.kaggle.com/code/kyuvarajg25ait2054/group13-ag-news-k} \\
           & HuggingFace Model & \url{https://huggingface.co/YuvarajK-g25ait2054/ag-news-distilbert} \\
           & W\&B & \url{https://wandb.ai/g25ait2054-iit-jodhpur/mlops-assignment3} \\
\midrule
G25AIT2056 & GitHub & \url{https://github.com/riteshmaury-iitj/group13-assignment-mlops} \\
           & Kaggle Notebook & \url{https://www.kaggle.com/code/khumanleima/notebook35f6cea6a6} \\
           & HuggingFace Model & \url{https://huggingface.co/LKHUMANLEIMA/ag-news-distilbert} \\
           & W\&B & \url{https://wandb.ai/g25ait2056-indian-institute-of-technology-jodhpur/mlops-assignment3} \\
\midrule
G25AIT2036 & GitHub (branch) & \url{https://github.com/riteshmaury-iitj/group13-assignment-mlops/tree/Sandeep_dev} \\
           & Kaggle Notebook & \url{https://www.kaggle.com/code/guntakalsandeepkumar/g25ait2036} \\
           & HuggingFace Model & \url{https://huggingface.co/guntaksa/AG-News-distilbert1} \\
           & W\&B & \url{https://wandb.ai/g25ait2036-indian-institue-of-technology-jodhpur/mlops-assignment3} \\
\bottomrule
\end{tabular}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{screenshots/github_collaborators.png}
\caption{GitHub Settings --- Collaborators: g25ait2036, g25ait2056-beep, YuvarajK-g25ait2054}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{screenshots/label_dist.png}
\caption{Test set label distribution --- 4 balanced classes, 1,900 samples each (7,600 total)}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{screenshots/length_dist.png}
\caption{Test set text length distribution --- word count per class (mean: 64 words, max: 200)}
\end{figure}
...
\caption{Docker container --- terminal output showing inference results for all 4 categories}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{screenshots/CICD.png}
