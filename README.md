...
![Label Distribution - Train Set](docs/label_distribution_train.png)
![Label Distribution - Test Set](docs/label_distribution_test.png)

### Text Length Statistics
![Text Length Distribution - Train Set](docs/text_length_train.png)
![Text Length Distribution - Test Set](docs/text_length_test.png)
...
## Dataset Visualization Notes

To display the dataset visualizations in this README, save the following files to the `docs/` directory:
1. `label_distribution_train.png` — Train set label distribution (balanced across 4 classes)
2. `label_distribution_test.png` — Test set label distribution (balanced across 4 classes)
3. `text_length_train.png` — Train set text length histogram (mean: ~226 characters)
4. `text_length_test.png` — Test set text length histogram (mean: ~225 characters)
